...
def main():
    ...
    # ── STATUS: Fleet health ─────────────────────────────────────
        ...
        print(f"🎨 Kiki     — Designer       ⏳ Not deployed yet")
        print(f"💻 Pip      — Developer      ⏳ Not deployed yet")
        print(f"🔬 Sage     — Researcher     ⏳ Not deployed yet")
        print(f"🧹 Dusty    — Sysadmin       ⏳ Not deployed yet")
        print(f"📋 Audit    — Logkeeper      ⏳ Not deployed yet")
        print(f"{'═'*40}")
